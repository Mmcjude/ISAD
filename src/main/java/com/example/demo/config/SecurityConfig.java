...
public class SecurityConfig {
	...
	public SecurityFilterChain configureEndpoints(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers("/plant/create").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/plant/update/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				...
				.requestMatchers("/plant/delete/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				
				.requestMatchers("/plant/variety/create").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/plant/variety/update/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				...
				.requestMatchers("/plant/variety/delete/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				
				.requestMatchers("/unit-of-genetics-and-breeding/sample/create").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/sample/update/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/sample/all").hasAnyAuthority("ADMIN", "STAFF", "GBLEADER")
				.requestMatchers("/unit-of-genetics-and-breeding/sample/delete/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/sample/details/**").hasAnyAuthority("ADMIN", "STAFF", "GBLEADER")
				
				.requestMatchers("/unit-of-genetics-and-breeding/species/create").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/species/update/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/species/all").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/species/delete/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/species/details/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				
				.requestMatchers("/unit-of-genetics-and-breeding/gene-fragment-length/create").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/gene-fragment-length/update/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/gene-fragment-length/all").hasAnyAuthority("ADMIN", "STAFF", "GBLEADER")
				.requestMatchers("/unit-of-genetics-and-breeding/gene-fragment-length/delete/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/gene-fragment-length/details/**").hasAnyAuthority("ADMIN", "STAFF", "GBLEADER")
				
				.requestMatchers("/unit-of-genetics-and-breeding/reference-gene/create").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/reference-gene/update/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
				.requestMatchers("/unit-of-genetics-and-breeding/reference-gene/all").hasAnyAuthority("ADMIN", "STAFF", "GBLEADER")
				.requestMatchers("/unit-of-genetics-and-breeding/reference-gene/delete/**").hasAnyAuthority("ADMIN", "GBLEADER", "STAFF")
